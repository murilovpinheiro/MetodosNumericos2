...
double fechada1(double A, double B, double erro_desejado) {
    ...
    while(erro_atual > erro_desejado) {
        ...
        for (int K = 0; K < N; K++){
            ...
            //Fórmula do Trapézio
            double area = (delta_x/2) * (funcao(xi) + funcao(xf));
            soma += area;
        }
...
double fechada2(function<double(double)> f, double A, double B, double erro_desejado) {
    //integrar a função <function> entre A e B
    double erro_atual = 10000;
    //quantidade <N> de subproblemas
    int N = 1;
...
double fechada3(function<double(double)> f, double A, double B, double erro_desejado) {
    //integrar a função <function> entre A e B
    double erro_atual = 10000;
    //quantidade <N> de subproblemas
    int N = 1;
...
double fechada4(function<double(double)> f, double A, double B, double erro_desejado) {
    //integrar a função <function> entre A e B
    double erro_atual = 10000;
    //quantidade <N> de subproblemas
    int N = 1;
