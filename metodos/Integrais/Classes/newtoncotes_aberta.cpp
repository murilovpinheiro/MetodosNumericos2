...
double NewtonCotesAberta::Grau0(double erro_desejado) {
    ...
    while(erro_atual > erro_desejado) {
        ...
        for (int K = 0; K < N; K++){
            ...
            //Newton-Cotes, Abordagem Aberta, Grau 0, uma função cosntante
            double area = 2 * h * f(x0);
            soma += area;
        }
...
double NewtonCotesAberta::Grau1(double erro_desejado) {
    //integrar a função <function> entre A e B
    double erro_atual = 10000;
    //quantidade <N> de subproblemas
    int N = 1;
...
double NewtonCotesAberta::Grau2(double erro_desejado) {
    //integrar a função <function> entre A e B
    double erro_atual = 10000;
    //quantidade <N> de subproblemas
    int N = 1;
...
double NewtonCotesAberta::Grau3(double erro_desejado) {
    //integrar a função <function> entre A e B
    double erro_atual = 10000;
    //quantidade <N> de subproblemas
    int N = 1;
...
//aberta 3 utilizando a filosofia central
double NewtonCotesAberta::Grau4(double erro_desejado) {
    //integrar a função <function> entre A e B
    double erro_atual = 10000;
    //quantidade <N> de subproblemas
    int N = 1;
